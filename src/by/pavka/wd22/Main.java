...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    TextParser textParser = new TextParserImpl("([A-Z]{1}[\\w\\s\\-\\,\\:\\;]+[\\.\\!\\?]{1," +
            "3})\\s", null);
    TextParser childParser = new TextParserImpl(null, "(.*?)\\p{Punct}? ");
    ...
    TextNode result2 = textParser.parse("It was rainy... I walked along the 5th street. I " +
            "smiled!! ");
